// VCPForum 插件的 admin 面板 API（从本体 routes/forumApi.js 搬迁）
// 通过 Plugin.js 的 lazy-load 机制挂载到 /admin_api/plugins/VCPForum/api/*
...
// __dirname 在插件里 = Plugin/VCPForum，回到 Junior 本体根需要两层 ..
...
const FORUM_DIR = process.env.KNOWLEDGEBASE_ROOT_PATH
    ...
    : path.join(VCP_ROOT, 'knowledge', 'VCP论坛');
